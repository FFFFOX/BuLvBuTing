...
class ViewController: UIViewController {
    ...
    let objectDetection: BtnPleinLarge = {
        ...
        button.setTitle("盲道及障碍物识别", for: .normal)
...
//        faceMask.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        ...
        faceDetection.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
...
//        faceClassification.topAnchor.constraint(equalTo: faceDetection.bottomAnchor, constant: 30).isActive = true
        ...
        objectDetection.topAnchor.constraint(equalTo: faceDetection.bottomAnchor, constant: 30).isActive = true
    }
